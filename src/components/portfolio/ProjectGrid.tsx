...
const projects: Project[] = [
  {
    ...
    testimonial: {
      name: 'Sarah Johnson',
      role: 'Homeowner',
      comment: 'Excellent service. The installers were here, polite and professional. We now have our State grants, County incentives and SRECs.We looking forward to filing our taxes to get our 30% grants from the federal.',
    },
  },
  {
    id: '2',
